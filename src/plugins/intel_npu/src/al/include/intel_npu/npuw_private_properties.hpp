 ...
 * Type: bool.
 *
 * Dump subgraph composition as a JSON file (.sg) describing the pipeline structure, including the list of unique
 * subgraphs, their repetition counts, and file paths.
 */
