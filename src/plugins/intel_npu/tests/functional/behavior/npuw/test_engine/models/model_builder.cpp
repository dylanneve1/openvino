...
// Magic-value constants and seeded-PRNG helpers (kRoPEBaseFrequency,
// fill_value_from_name, xorshift32, seed_from_name) live in model_builder_internal.hpp
// (shared with split component files).
